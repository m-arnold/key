...
public class TacletBuilderManipulators {
    ...
    public static final AbstractConditionBuilder IMMUTABLE_FIELD =
            new ConstructorBasedBuilder("isImmutableField", ImmutableFieldCondition.class, FSV);
    ...
    static {
        register(SAME_OBSERVER, SIMPLIFY_ITE_UPDATE, ABSTRACT_OR_INTERFACE, SAME, IS_SUBTYPE,
            ...
            STATIC_FIELD, MODEL_FIELD, IMMUTABLE_FIELD, SUBFORMULA, DROP_EFFECTLESS_STORES, EQUAL_UNIQUE,
            META_DISJOINT,
